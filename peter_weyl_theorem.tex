...
Darstellungen genauer zu studieren. Dies wirkt zuerst stark
einschränkend, jedoch werden wir sehen, dass auf einer 
kompakten Gruppe dies tatsächlich schon alle Darstellungen
sind.\\
...
Skalaproofukt durch den Ausdruck
...
Satz \ref{thm:propsModularFunction} anwenden können.
\end{proof}

Dies erlaubt es uns also, endlichdimensionale Darstellungen
immer als unitäre Darstellungen aufzufassen.
\printindex
\end{document}
